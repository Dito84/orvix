...
import { SettingsParentalControlFacade } from './settings-parental-control.facade';
import { SettingsParentalControlSectionComponent } from './settings-parental-control-section.component';
...
@Component({
    ...
    imports: [
        ...
        SettingsParentalControlSectionComponent,
    ...
    implements OnInit, OnDestroy, SettingsLeaveConfirmation
{
    ...
    readonly parentalControl = inject(SettingsParentalControlFacade);
